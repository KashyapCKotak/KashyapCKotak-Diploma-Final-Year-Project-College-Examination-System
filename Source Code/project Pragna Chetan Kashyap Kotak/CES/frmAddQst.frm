...
Begin VB.Form frmAddQst 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame4 
         ...
         Top             =   960
         Width           =   19815
         Begin RichTextLib.RichTextBox txtAns 
            Height          =   1095
            Left            =   2160
            TabIndex        =   41
            Top             =   7560
            ...
            Enabled         =   -1  'True
            ScrollBars      =   3
            TextRTF         =   $"frmAddQst.frx":0442
         End
         Begin RichTextLib.RichTextBox txtOpt4 
            Height          =   1095
            Left            =   2160
            TabIndex        =   40
            Top             =   6240
            ...
            Enabled         =   -1  'True
            ScrollBars      =   3
            TextRTF         =   $"frmAddQst.frx":04C4
         End
         Begin RichTextLib.RichTextBox txtOpt3 
            Height          =   1095
            Left            =   2160
            TabIndex        =   39
            Top             =   5040
            ...
            Enabled         =   -1  'True
            ScrollBars      =   3
            TextRTF         =   $"frmAddQst.frx":0546
         End
         Begin RichTextLib.RichTextBox txtOpt2 
            Height          =   1095
            Left            =   2160
            TabIndex        =   38
            Top             =   3840
            ...
            Enabled         =   -1  'True
            ScrollBars      =   3
            TextRTF         =   $"frmAddQst.frx":05C8
         End
         Begin RichTextLib.RichTextBox txtOpt1 
            Height          =   1095
            Left            =   2160
            TabIndex        =   37
            Top             =   2640
            ...
            Enabled         =   -1  'True
            ScrollBars      =   3
            TextRTF         =   $"frmAddQst.frx":064A
         End
         Begin RichTextLib.RichTextBox txtQst 
            Height          =   2415
            Left            =   2160
            TabIndex        =   36
            Top             =   120
...
Else
    If (txtOpt1.Text <> txtAns.Text And txtOpt2.Text <> txtAns.Text And txtOpt3.Text <> txtAns.Text And txtOpt4.Text <> txtAns.Text) Then
        MsgBox "Answer key does not match any one of 4 options", vbCritical, " CES"
        txtAns.Text = ""
        txtAns.SetFocus
    Else
    ...
    con.Execute ("insert into ExamDetails values('" + cmbBranch.Text + "'," + cmbSem.Text + _
            ...
            MsgBox "Question Added Successfully", vbInformation, " CES"
            txtAns.Text = ""
            txtOpt1.Text = ""
            txtOpt2.Text = ""
            txtOpt3.Text = ""
